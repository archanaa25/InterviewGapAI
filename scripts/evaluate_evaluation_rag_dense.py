...
# Support direct execution as well as python -m scripts.evaluate_evaluation_rag_dense.
...
RESULTS_FILE = Path(
    "data/eval/evaluation_rag_dense_results.jsonl"
)
...
def main():
    ...
    print("\n" + "=" * 70)
    print("EVALUATION RAG — DENSE BASELINE")
    print("=" * 70)
